...
import glob
ckpt_hits = glob.glob("/kaggle/input/**/weights_resnet50_cosine_anneal.pth", recursive=True)
if not ckpt_hits:
    raise FileNotFoundError("Could not find weights_resnet50_cosine_anneal.pth under /kaggle/input")
CKPT = ckpt_hits[0]
